...
// static const u8* fun_fmt_64 =
//   "\n"
//   "/* CUSTOM: track call chain step */\n"
//   "\n"
//   ".align 4\n"
//   "leaq -(128+24)(%%rsp), %%rsp\n"
//   "movq %%rdx, 0(%%rsp)\n"
...
//   "movq %%rax, 16(%%rsp)\n"
//   "\n"
//   "/* Load SHM base (__afl_area_ptr) */\n"
//   "movq __afl_area_ptr(%%rip), %%rdx\n"
//   "testq %%rdx, %%rdx\n"
//   "je 1f\n"
//   "\n"
//   "/* rcx = current index (0~4) */\n"
//   "movq $0x%02x, %%rcx\n"
//   "\n"
//   "/* If index == 0, set directly */\n"
//   "cmpq $0, %%rcx\n"
//   "je 2f\n"
//   "\n"
//   "/* Check previous index (rcx - 1) is non-zero */\n"
//   "movb -1(%%rdx, %%rcx, 1), %%al\n"
//   "testb %%al, %%al\n"
//   "jz 1f\n"
//   "\n"
//   "2:\n"
//   "/* Set bitmap[current_index] = 1 */\n"
//   "movb $1, (%%rdx, %%rcx, 1)\n"
//   "\n"
//   "1:\n"
//   "movq 16(%%rsp), %%rax\n"
...
static const u8* end_fun_64 =
  "\n"
  "/* CUSTOM: check full chain and crash */\n"
  "\n"
  ".align 4\n"
  "leaq -(128+16)(%%rsp), %%rsp\n"
  "movq %%rax, 0(%%rsp)\n"
  ...
  "je 1f\n"
  "\n"
  "/* Check indices 0 to 4 are all non-zero */\n"
  "/* Check previous index (rcx - 1) is non-zero */\n"
  "movb -1(%%rdx, %%rcx, 1), %%al\n"
  "testb %%al, %%al\n"
  "jz 1f\n"
  "\n"
  "/* Full chain executed! Trigger crash */\n"
  "ud2\n"
  "\n"
  "1:\n"
  "movq 0(%%rsp), %%rax\n"
...
// #endif /* ^SKIP_COUNTS */
//   "\n"
  "  /* Custom logic: if rcx > 16, do normal inc; else apply special rule */\n"
  "  cmpq $16, %rcx\n"
  "  ja   __afl_do_normal\n"
  "\n"
  "  /* rcx <= 16 */\n"
  "  testq %rcx, %rcx\n"
  "  jz    __afl_rcx_is_zero\n"
  "\n"
  "  /* rcx != 0 and <= 16: check if bitmap[rcx - 1] > 0 */\n"
  "  movb  -1(%rdx, %rcx, 1), %al\n"
  "  testb %al, %al\n"
  "  jz    __afl_return\n"
  "  movb  $1, (%rdx, %rcx, 1)\n"
